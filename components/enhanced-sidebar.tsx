...
export function EnhancedSidebar() {
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <motion.aside
        className="fixed inset-y-0 left-0 z-40 flex flex-col w-[280px] bg-white/90 dark:bg-gray-950/90 backdrop-blur-md border-r border-gray-200/50 dark:border-gray-800/50 md:hidden"
        initial="closed"
            ...
            {stakeholderButtons.map((button) => (
              <Button
                ...
                className={cn(
                  ...
                  stakeholderType === button.type && `bg-gradient-to-r ${button.gradient} text-white shadow-md`,
                )}
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  pathname === item.href
                    ? "bg-gradient-to-r from-blue-50 to-blue-100 text-blue-600 dark:from-blue-950 dark:to-blue-900 dark:text-blue-400 shadow-sm"
          ...
          {userProfile && (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Avatar className="h-8 w-8 border border-gray-200/50 dark:border-gray-700/50 shadow-sm">
      ...
      {/* Desktop Sidebar */}
      <motion.aside
        className="hidden md:flex flex-col h-screen sticky top-0 border-r border-gray-200/50 dark:border-gray-800/50 bg-white/90 dark:bg-gray-950/90 backdrop-blur-md z-30"
